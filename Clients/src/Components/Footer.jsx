    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 text-center md:text-left"
        >
          {/* Brand Section */}
          <motion.div variants={fadeInUp}>
            <h3 className="text-2xl font-bold mb-4">Jobfinder</h3>
          ...
          <motion.div variants={fadeInUp}>
            ...
            <div className="flex justify-center md:justify-start gap-4">
              ...
              <motion.a
                ...
                variants={fadeInUp}
                whileHover={{ scale: 1.2, rotate: 10 }}
                animate={{ scale: [1, 1.1, 1], transition: { duration: 2, repeat: Infinity, ease: 'easeInOut', delay: 0.2 } }}
                className="text-gray-400 hover:text-white transition-colors duration-200"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <motion.a
                ...
                variants={fadeInUp}
                whileHover={{ scale: 1.2, rotate: 10 }}
                animate={{ scale: [1, 1.1, 1], transition: { duration: 2, repeat: Infinity, ease: 'easeInOut', delay: 0.4 } }}
                className="text-gray-400 hover:text-white transition-colors duration-200"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
